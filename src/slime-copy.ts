...
export const SLIME_COPY: [string, string, string][] = [
 ...
 ['Все вместе','Alle zusammen','All together'],['Все малыши рядом','Alle Babys sind dabei','All babies beside you'],['Сейчас рядом','Jetzt dabei','Beside you now'],['Рядом со мной','Komm zu mir','Stand beside me'],
 ['Выбери, кто стоит рядом. Большой ряд малышей можно листать.','Wähle, wer bei dir steht. Bei vielen Babys kannst du die Reihe seitlich schieben.','Choose who stands beside you. Swipe the row to see more babies.'],
 ['Теперь все малыши рядом!','Jetzt sind alle Babys dabei!','Now all the babies are beside me!'],['{{baby}} теперь рядом со мной!','{{baby}} ist jetzt bei mir!','{{baby}} is beside me now!'],
 ['Изменить имя','Namen ändern','Change name'],['Имя малыша','Name des Babys','Baby’s name'],['Сохранить имя','Namen speichern','Save name'],['Отмена','Abbrechen','Cancel'],['Впиши имя малыша.','Gib einen Namen ein.','Enter a name for the baby.'],['Обнять малыша','Baby umarmen','Hug baby'],
 ['Две крошечки соединились! Привет, {{baby}}! ♡','Zwei Stückchen sind zusammengekommen! Hallo, {{baby}}! ♡','Two little pieces joined together! Hello, {{baby}}! ♡'],
 ['{{baby}}: «Пи-пи! Обнимаю!» ♡','{{baby}}: „Piep-piep! Eine Umarmung!“ ♡','{{baby}}: “Peep-peep! Hugs!” ♡'],
 ['Теперь меня зовут {{baby}}!','Jetzt heiße ich {{baby}}!','My name is {{baby}} now!'],
 ['Ещё один малыш','Noch ein Baby','Another baby'],
 ['Как сделать ещё одного малыша','So bekommt ihr noch ein Baby','How to make another baby'],
 ['Как сделать малыша','So bekommt ihr ein Baby','How to make a baby'],
 ['1. Спроси разрешение играть.','1. Bitte um Erlaubnis zum Spielen.','1. Ask for permission to play.'],
 ['2. Подружитесь: три сердечка.','2. Werdet Freunde: drei Herzen.','2. Become friends: three hearts.'],
 ['3. Спросите обоих слаймов, хотят ли они малыша.','3. Fragt beide Slimes, ob sie ein Baby möchten.','3. Ask both slimes whether they want a baby.'],
 ['4. Каждый дарит по кусочку — малыш готов!','4. Jeder schenkt ein Stückchen – das Baby ist da!','4. Each gives a little piece — here comes the baby!'],
 ['Нужно умыться.','Zeit zum Waschen.','Time to wash.'],
 ['Нужно отдохнуть вместе.','Zeit, gemeinsam auszuruhen.','Time to rest together.'],
 ['Нужно ещё поиграть или погладить слайма.','Spiele noch etwas oder streichle den Slime.','Play a little more or pet the slime.'],
 ['Отдохнуть вместе','Gemeinsam ausruhen','Rest together'],
 ['Посидели на травке и отдохнули. Теперь можно снова спросить про малыша!','Wir haben uns im Gras ausgeruht. Jetzt können wir wieder nach einem Baby fragen!','We rested on the grass. Now we can ask about a baby again!'],
 ['Семья слаймов','Slime-Familie','Slime family'],['Наши малыши','Unsere Babys','Our babies'],
 ['Нажми на малыша, чтобы обнять. На прогулке можно сделать ещё одного!','Tippe auf ein Baby zum Umarmen. Beim Spaziergang kann noch eins dazukommen!','Tap a baby to hug it. You can make another one on a walk!'],
