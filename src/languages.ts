...
> = {
  ru: {
    ...
    navLabel: 'Игры',
    kuckuckName: 'Kuckuck',
    kuckuckBlurb: 'Тук-тук! За дверью — 15 разных животных.',
  ...
  de: {
    ...
    navLabel: 'Spiele',
    kuckuckName: 'Kuckuck',
    kuckuckBlurb: 'Klopf, klopf! Hinter der Tür warten 15 verschiedene Tiere.',
    chunyashkaName: 'Чуняшка',
  ...
  en: {
    ...
    navLabel: 'Toys',
    kuckuckName: 'Kuckuck',
    kuckuckBlurb: 'Knock, knock! Meet 15 different animals behind the door.',
