...
for (const visitor of ['cat', 'dog', 'bird', 'duck', 'bunny', 'mouse', 'cow', 'bear', 'frog', 'capybara', 'fox', 'elephant', 'owl', 'hedgehog', 'penguin', 'sheep', 'pig', 'horse', 'rooster', 'hen', 'bee', 'goat', 'donkey', 'goose', 'cuckoo', 'monkey']) {
  const page = await browser.newPage({
